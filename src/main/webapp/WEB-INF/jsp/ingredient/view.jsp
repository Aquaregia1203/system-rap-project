                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box">
                            ...
                            <h4 style="font-family: 'Nanum Gothic',sans-serif">원재료 상세 정보</h4>
                        </div>
                    </div>
                </div>
                <div class="row">
                        ...
                        <div class="card-box table-responsive">
                            ...
                            <div class="col-sm-12 text-right">
                                <form action="${pageContext.servletContext.contextPath}/ingredient" method="post">
                                    ...
                                    <a href="${pageContext.servletContext.contextPath}/ingredient" class="btn btn-secondary waves-effect">목록</a>
                                </form>
                            </div>
                        </div>
                    </div>
